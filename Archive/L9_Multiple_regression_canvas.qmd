...
- So, a z-score of 1 ($z = 1$) means that that particular score for $X$ is one standard deviation higher than the mean, and a a-score of -1 would indicate a score 1SD below the mean.
