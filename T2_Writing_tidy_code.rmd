...
:::{.column width=50%}
- We will are working on R markdown and R Scripts - these are the files with the `.rmd` and `.R` file type. 
- Make sure you have commented and bookmarked important sections of the R script.  
