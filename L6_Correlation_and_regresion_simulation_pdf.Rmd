...
-   However, you can rest easy knowing that the weight/height
    relationship, as specified by the variance vocariance matrix, has been preserved.


# Simulating a large dataset {.smaller}
...
```{r tidyplot sim data 2, eval = T, echo=FALSE}
