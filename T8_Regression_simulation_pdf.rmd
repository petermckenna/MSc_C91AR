...
# Futher instructions
  ...
  - See [my Markdown doc for Monday's lecture on Github](https://github.com/petermckenna/MSc_C91AR/blob/main/L7_Regression_pdf.rmd) to familiarise yourself with the notation format using $ wrappers. These are to be written in the regular text sections of your Markdown document. 
